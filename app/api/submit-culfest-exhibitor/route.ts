...
const GOOGLE_FORM_RESPONSE_URL =
  'https://docs.google.com/forms/d/e/1FAIpQLSetjAFDTTcpJOb5qO6Tn8is76ehb3XlVW2ZnZaEsEmyp9Nc4A/formResponse';

// Entry IDs from the D-8 HEI CulFest Register Exhibitor form (from prefill URL)
const ENTRY_IDS = {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('CulFest exhibitor form submission error:', error);
    return NextResponse.json(
