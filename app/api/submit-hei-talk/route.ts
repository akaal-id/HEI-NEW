...
// Entry IDs from the D-8 HEI Talk Register Visitor form (from prefill URL)
const ENTRY_IDS = {
  salutation: 'entry.1040857053',
  fullName: 'entry.1791207854',
  companyName: 'entry.215633819',
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('HEI Talk form submission error:', error);
    return NextResponse.json(
