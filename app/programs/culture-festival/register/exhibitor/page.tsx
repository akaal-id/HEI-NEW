...
export default function CulFestRegisterExhibitorPage() {
  ...
  const buildConfirmRows = (): RegistrationModalRow[] => [
    { label: 'Status', value: 'Cultural Festival Exhibitor', highlight: true },
  ...
  const validate = () => {
    setTouched({
      ...
      businessCategoryOther: true,
      marketSector: true,
      marketSectorOther: true,
    });
  ...
  const handleModalConfirm = async () => {
    ...
    try {
      const res = await fetch('/api/submit-culfest-exhibitor', {
        method: 'POST',
    ...
    <main className={styles.page}>
      <section className={styles.heroSection}>
        <div className={styles.heroContainer}>
          ...
          <p className={styles.heroSubtitle}>D-8 HEI Cultural Festival 2026</p>
        </div>
      </section>
      ...
      <RegistrationModal
        ...
        successMessage="Thank you for registering as an exhibitor for D-8 HEI Cultural Festival 2026. Please check your inbox for a confirmation email."
