...
export const metadata: Metadata = {
  ...
  description:
    'Register as a visitor or exhibitor for D-8 HEI Cultural Festival 2026 in Jakarta. Join the cultural celebration of worldwide nations.',
  keywords: [
    'cultural festival registration',
    'D-8 HEI CulFest registration',
    'CulFest visitor registration',
