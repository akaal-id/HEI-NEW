...
export default function CulFestRegisterVisitorPage() {
  ...
  const buildConfirmRows = (): RegistrationModalRow[] => [
    { label: 'Status', value: 'Cultural Festival Visitor', highlight: true },
  ...
  const handleModalConfirm = async () => {
    ...
    try {
      const res = await fetch('/api/submit-culfest-visitor', {
        method: 'POST',
  ...
  return (
    <main className={styles.page}>
      ...
      <RegistrationModal
        ...
        successMessage="Thank you for registering for D-8 HEI Cultural Festival 2026. Please check your inbox for a confirmation email."
